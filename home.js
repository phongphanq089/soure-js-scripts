...
(function () {
  ...
  t.g.prototype.currentTime = function () {
    return this.seeking()
      ? this.ke || 0
      : this.c.vjs_getProperty("currentTime");
  };
  ...
  function X(a) {
    ...
    a.Ge
      ? (c = a.Ge[0])
      : a.options && (c = a.options[a.options.selectedIndex]);
    return c.value;
  }
  function Y(a, c) {
    var d, e;
...
$(window).on("load", function () {
  // slide Tesimonial
  if ($(".showTesimonialSlider ").length) {
    $(".showTesimonialSlider ").slick({
      // autoplay: true,
      pauseOnHover: false,
      pauseOnFocus: false,
      dots: true,
  ...
  // end slide Tesimonial

  // banner hero slider 1
  ...
  if ($(".heroSlider2").length) {
    $(".heroSlider2")
      .slick({
        ...
        speed: 800,
        lazyLoad: "progressive",
        dotsClass: "slideDotsHero2",
        dots: false,
        prevArrow:
          '<div class="slick-nav prev-arrow"><i class="fa-solid fa-chevron-left icon"></i></div>',
        nextArrow:
          '<div class="slick-nav next-arrow"><i class="fa-solid fa-chevron-right icon"></i></div>',
      })
      .slickAnimation();
  }
  // end slider 2

  // banner hero slider 3
  if ($(".heroSlider3").length) {
    $(".heroSlider3")
      .slick({
        // autoplay: true,
        arrows: false,
  ...
  // banner hero slider 4
  if ($(".heroSlider4").length) {
    $(".heroSlider4")
      .slick({
        // autoplay: true,
        arrows: true,
  ...
  // banner hero slider 5
  if ($(".heroSlider5").length) {
    $(".heroSlider5").slick({
      autoplay: true,
      arrows: true,
      slidesToShow: 1,
  ...
  // banner hero slider 6
  if ($(".heroSlider6").length) {
    $(".heroSlider6").slick({
      // autoplay: true,
      arrows: true,
      slidesToShow: 1,
